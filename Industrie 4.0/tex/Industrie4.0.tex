...
\begin{figure}[h]
  \centering
  	\fbox{
     \includegraphics[width=0.4\textwidth]{../Graphics/KommunikationsKette.jpg}
     }
  \caption{Kommunikationskette}
  \label{Kommunikationskette}
\end{figure}

\begin{itemize}
  \item Horizontale Integration über Wertschöpfungskette
  \item Vertikale Integarion und vernetzte Produktionssysteme
\end{itemize}
...
\section{Welche Aspekte von Industrie 4.0 decken wir heute schon ab?}

\begin{tabular}{lllll}
\emph{lfd. Nr.}	& \emph{Themenbereich Industrie 4.0} &
\emph{Beschreibung}\\
\hline
21 & vertikale Integration	& Vernetzung vieler Produktionsmaschinen (plus Mess- und\\
& & Auswertesysteme etc.) / FLS-System / ERP-System (SAP)\\
22 & horizontale Integration &
Vernetzung/Kommunikation Rheinwerk / AluNorf / GV\\
23 & vertikale Integration &
Daten-/Materialfluss und Datenkontrolle zu jeder Zeit\\
24 & Prozessautomatisierung & Automatisches Scheduling an den Maschinen unter Beachtung der\\
& & Arbeitsgangreihenfolgen;\\
& & automatisches Zu- und Abdienen; \\
& & Automatische Optimierungen in den Lagerbereichen
